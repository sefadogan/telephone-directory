...
function handleboxedLayout() {
    ...
    if ($('body').hasClass('boxed')) {
        ...
        if (!$('body').hasClass('sidebar-top') && windowWidth > 1220)  {
            ...
            $.backstretch(["~/Areas/Panel/assets/global/images/gallery/bg1.jpg", "~/Areas/Panel/assets/global/images/gallery/bg2.jpg", "~/Areas/Panel/assets/global/images/gallery/bg3.jpg", "~/Areas/Panel/assets/global/images/gallery/bg4.jpg"], 
